...
export class AddStockSupplyDataComponent implements OnInit {
  ...
  constructor(
    ...
    this.breadcrumbs = ['Add Stock\'s Supply Data', 'Enter the total no. of Stocks and date till which it can be supplied based on various requirements Implement-wise'];
  }
