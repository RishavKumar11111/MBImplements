...
export class StockAvailabilityComponent implements OnInit {
  ...
  constructor(
    ...
    this.title = 'Stock Availability';
    this.breadcrumbs = ['Stock Availability', 'Entry of the surplus stocks district-wise and implement-wise'];
    this.districtList = [];
  ...
  @ViewChild('stockAvailabilityForm') saForm: any;
